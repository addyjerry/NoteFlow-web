...
const LoginMenu = ({ handleLogin }) => {
  return (
    <div className="left-0 top-0 backdrop-blur flex  p-5 fixed w-full h-[100vh] place-content-center z-20">
      <div className="place-self-center p-10 lg:px-90 flex justify-self-center rounded-2xl ">
        ...
        <div className="dark:bg-[#050e0e] bg-blue-300 lg:w-xs w-3xs px-10 py-5">
          ...
          <MyButton className=" text-xs w-full justify-center">
            Get Started
          </MyButton>
        </div>
      </div>
